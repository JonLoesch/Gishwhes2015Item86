...
app.controller('randomizer', function($scope) {
    $scope.components = {
        hat: new Set([
            new Segment({
                src: '/Gishwhes2015Item86/giranimals/hat1.small.png',
                aspect: 625/1000,
                base: new Anchor(new Victor(-0.25, .1896), new Victor(0.496, -0.1008)),
                docks: {},
            }),
            new Segment({
                src: '/Gishwhes2015Item86/giranimals/hat2.small.png',
                aspect: 1000/1000,
                base: Anchor.fromString('-0.354 0.205   0.725   -0.052'),
                docks: {},
            }),
            new Segment({
                src: '/Gishwhes2015Item86/giranimals/hat3.small.png',
                aspect: 573/1000,
                base: Anchor.fromString('-0.247 0.260907504 0.497   0'),
                docks: {},
            }),
            new Segment({
                src: '/Gishwhes2015Item86/giranimals/hat4.small.png',
                aspect: 778/1000,
                base: Anchor.fromString('-0.297 0.205655527 0.588   0.00,570694'),
                docks: {},
            }),
            new Segment({
                src: '/Gishwhes2015Item86/giranimals/hat5.small.png',
                aspect: 591/1000,
                base: Anchor.fromString('-0.469 0.371404399 0.682   -0.421319797'),
                docks: {},
            }),
            new Segment({
                src: '/Gishwhes2015Item86/giranimals/hat6.small.png',
                aspect: 912/1000,
                base: Anchor.fromString('-0.28  0.292763158 0.508   -0.027412281'),
                docks: {},
            }),
            new Segment({
                src: '/Gishwhes2015Item86/giranimals/hat7.small.png',
                aspect: 673/1000,
        ...
        head: new Set([
            new Segment({
                src: '/Gishwhes2015Item86/giranimals/head1.small.png',
                aspect: 833/1000,
            ...
            new Segment({
                src: '/Gishwhes2015Item86/giranimals/head6.small.png',
                aspect: 1280/1000,
            ...
            new Segment({
                src: '/Gishwhes2015Item86/giranimals/head7.small.png',
                aspect: 873/1000,
            ...
            new Segment({
                src: '/Gishwhes2015Item86/giranimals/head8.small.png',
                aspect: 715/1000,
        ...
        body: new Set([
            new Segment({
                src: '/Gishwhes2015Item86/giranimals/body1.small.png',
                aspect: 2700/2700,
